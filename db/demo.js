...
module.exports = function(client) {
  ...
  client.query(`CREATE TABLE user__c (
    id SERIAL NOT NULL,
    email CHARACTER VARYING(80) UNIQUE,
    password CHARACTER VARYING(80)
  );`);

  bcryptjs.genSalt(10, (err, salt) => {
    bcryptjs.hash('admin', salt, (err, hash) => {
      if (err) {
        console.log(err); 
        return;
      } else {
        client.query(`INSERT INTO user__c (email, password) VALUES ('admin@gmail.com', '`+ hash +`');`);
